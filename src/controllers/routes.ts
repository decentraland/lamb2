...
import { wearablesHandler, thirdPartyWearablesHandler } from './handlers/wearables-handler'
...
export async function setupRouter(_: GlobalContext): Promise<Router<GlobalContext>> {
  ...
  // router.get('/users/:address/third-party-wearables/collections/:collection-id', thirdPartyWearablesHandler)
