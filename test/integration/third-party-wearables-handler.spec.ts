...
// const pre2: () => { fetchComponent?: IFetchComponent, theGraphComponent?: TheGraphComponent } = () => ({})
...
testWithComponents(() => {
  ...
  theGraphMock.thirdPartyRegistrySubgraph.query = jest.fn().mockResolvedValueOnce([{
    thirdParties: [{
      id: 'urn:decentraland:matic:collections-thirdparty:baby-doge-coin',
      resolver: 'https://decentraland-api.babydoge.com/v1'
    }]
